...
public class NoSyncOrCloseBufferedWriter extends BufferedWriter
{
    ...
    public NoSyncOrCloseBufferedWriter(final OutputStream stream)
    {
        this(new OutputStreamWriter(Objects.requireNonNull(stream)));
    }
    
    public NoSyncOrCloseBufferedWriter(final OutputStream stream, final int capacity)
    {
