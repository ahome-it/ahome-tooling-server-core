...
import com.ait.tooling.server.core.support.spring.telemetry.ITelemetryService;

public interface IServerContext extends IJSONUtilities, IAuthorizer, IPropertiesResolver, ITelemetryService, Serializable
{
