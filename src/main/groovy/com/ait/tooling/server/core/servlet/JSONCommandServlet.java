...
import com.ait.tooling.server.core.rpc.JSONRequestContext;
import com.ait.tooling.server.core.security.AuthorizationResult;

@SuppressWarnings("serial")
public class JSONCommandServlet extends HTTPServletBase
{
    private static final Logger logger = Logger.getLogger(JSONCommandServlet.class);
    ...
    public void doPost(final HttpServletRequest request, final HttpServletResponse response) throws IOException
    {
        ...
        final IJSONCommand command = getServerContext().getCommand(name);
    ...
    {
        return getServerContext().getServerManager().isRunning();
    }
}