...
{
    private final ArrayList<IServletContextCustomizer> m_list = new ArrayList<IServletContextCustomizer>();
    ...
    {
        for (IServletContextCustomizer customizer : getServletContextCustomizerList())
        {
            customizer.close();
        }
    }
